...
- all the result and grilling in french
...
Then delegate the codebase walk to a read-only explorer — on Codex, use a scout agent (see the codex-orchestrator skill). Don't follow rigid heuristics — explore organically and note where you experience friction:
